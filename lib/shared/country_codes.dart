...
class AppCountryCodes {
  static const List<Map<String, String>> countryDetails = [
  ...
  static Map<String, String> getCurrentCountryDetails() {
    CountryDetails details = CountryCodes.detailsForLocale();
    if (details.dialCode != null) {
      List currentCountry = countryDetails
          .where((element) => element['dial_code'] == details.dialCode)
          .toList();
