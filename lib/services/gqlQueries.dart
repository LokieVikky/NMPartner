const String query_insertShopDetail = r''' 
...
const String query_inserShopAddress = r''' 
...
const String query_updatePartnerInfo = r'''
mutation MyMutation($userId: uuid = "", $name: String = "", $avatar: String = "",
...
String queryGetActionRequired = r'''
query MyQuery($shopId: uuid = "") {
...
String queryChangeOrderStatus = r'''
...
String queryInsertSubCategory = r'''
...
String queryUpdateProfile = r'''
mutation MyMutation($partnerId: uuid!, $partnerName : String!,
$partnerStreet :String!, $partnerCity : String!, $partnerHouseNo : String!, $partnerLandmark : String!, $partnerLatlng : String!, $partnerPincode : String!,
$shopId : uuid!, $shopName : String!, $shopDescription : String!,
$shopStreet :String!, $shopCity : String!, $shopHouseNo : String!, $shopLandmark : String!, $shopLatlng : String!, $shopPincode : String!,

) {
item1: update_namma_mechanics_partner(where: {id: {_eq: $partnerId}}, _set: {name: $partnerName}) {
returning {
id
}
}
item2: update_namma_mechanics_address(where: {partner_id: {_eq: $partnerId}}, _set: {apartment_road_area: $partnerStreet, city: $partnerCity, house_no: $partnerHouseNo, landmark: $partnerLandmark, latlng: $partnerLatlng, pincode: $partnerPincode}) {
returning {
id
}
}
update_namma_mechanics_address(where: {shop_id: {_eq: $shopId}}, _set: {apartment_road_area: $shopStreet, city: $shopCity, house_no: $shopHouseNo, landmark: $shopLandmark, latlng: $shopLatlng, pincode: $shopPincode}) {
returning {
id
}
}

update_namma_mechanics_shop(where: {id: {_eq: $shopId}}, _set: {description: $shopDescription, name: $shopName}) {
returning {
id
}
}
